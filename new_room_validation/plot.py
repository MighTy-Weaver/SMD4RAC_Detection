...
plt.title("Average Highest Accuracy by Five Models in Classification Task", fontsize=18)
plt.subplot(2, 2, 2)
sns.heatmap(heatmap_df_f1_mean.to_numpy(), annot=add_annot, xticklabels=gs_choices,
            yticklabels=[int(i * 0.8) for i in data_num_choices], cmap="YlGnBu", fmt=".2f", linewidths=linewidth)
plt.xlabel("Number of data points in one sparse data sample", fontsize=18)
plt.ylabel("Number of Training data", fontsize=18)
plt.title("Average Highest $F_1$ Score by Five Models in Classification Task", fontsize=18)
plt.subplot(2, 2, 3)
...
plt.xlabel("Number of data points in one sparse data sample", fontsize=18)
plt.ylabel("Number of Training data", fontsize=18)
plt.title("Average Minimum RMSE by Five Models in Regression Task", fontsize=18)
plt.subplot(2, 2, 4)
...
plt.xlabel("Number of data points in one sparse data sample", fontsize=18)
plt.ylabel("Number of Training data", fontsize=18)
plt.title("Average Highest $R^2$ Score by Five Models in Regression Task", fontsize=18)
